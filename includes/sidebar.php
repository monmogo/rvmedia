   ...
   <aside class="sidebar">
       ...
       <ul class="nav flex-column">
           ...
           <li class="nav-item">
               <a class="nav-link" href="manage_wallet.php">💰 Quản lý Nạp/Rút</a>
           </li>
           <li class="nav-item">
               <a class="nav-link" href="manage_themes.php">📦 Quản lý Theme</a>
           </li>
           <li class="nav-item">
           ...
           <li class="nav-item">
               <a class="nav-link" href="manage_banners.php">📢 Quản lý Banner</a>
           </li>
           <li class="nav-item">
